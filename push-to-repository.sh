...
echo "PACKAGECLOUDTOKEN=${secret.PACKAGECLOUDTOKEN}"
echo "PACKAGECLOUD_TOKEN=${secret.PACKAGECLOUD_TOKEN}"
export PACKAGECLOUDTOKEN="${secret.PACKAGECLOUDTOKEN}"
export PACKAGECLOUD_TOKEN="${secret.PACKAGECLOUD_TOKEN}"
